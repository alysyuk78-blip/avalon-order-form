...
function setupInstructions(ss) {
  ...
  var lines = [
    ...
    "Щойно статус став «В роботі» — замовлення вже надіслано підряднику в групу (гілка ORD-…). Подальші правки в таблиці туди автоматично НЕ підтягуються — напиши зміни вручну в гілці цього замовлення.",
    "ДАТУ ДОСТАВКИ можна міняти будь-коли: вона сама оновлюється в Google Календарі, а нагадування підлаштовуються автоматично.",
    "СКАСУВАННЯ: не видаляй рядок — постав статус «Скасовано». Запис і фінанси збережуться, а нагадування більше не надходитимуть. (Статуси «Відправлено» і «Завершено» теж зупиняють нагадування.)",
